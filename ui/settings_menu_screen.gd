...
var resolutions: Dictionary = {
	...
	"640x270": Vector2i(640, 270),
	"854x480": Vector2i(854, 480),
	"1280x720": Vector2i(1280, 720)
}

func _ready():
	for windows_mode in windows_modes:
		window_mode_option_button.add_item(windows_mode)
...
func _on_window_mode_option_button_item_selected(index):
	var window_mode = windows_modes.get(window_mode_option_button.get_item_text(index)) as int
